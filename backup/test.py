...
pkt_ipv4_03 = Ether(src="54:B2:03:91:14:26",dst="54:B2:03:91:33:02")/\
      IP(src='10.0.0.1', dst='10.0.0.3')/\
      data
pkt_ipv4_04 = Ether(src="54:B2:03:91:14:26",dst="54:B2:03:91:33:03")/\
      IP(src='10.0.0.1', dst='10.0.0.4')/\
      data
pkt_pwl_11 = Ether(src="12:34:56:78:90:10",dst="12:34:56:78:90:11",type=0x88ab)/\
      IP(src='10.0.0.10', dst='10.0.0.11')/\
      data
pkt_pwl_12 = Ether(src="12:34:56:78:90:10",dst="12:34:56:78:90:12",type=0x88ab)/\
      IP(src='10.0.0.10', dst='10.0.0.12')/\
      data
pkt_ipv6_7891 = Ether(src="54:B2:03:91:32:A0",dst="54:B2:03:91:30:9C")/\
    IPv6(src='1234::5678:9012:3456:7891', dst='fe80::e695:6eff:fe2f:2278')\
    /\
     data
pkt_ipv6_7892 = Ether(src="54:B2:03:91:32:A0",dst="54:B2:03:91:30:9C")/\
    IPv6(src='1234::5678:9012:3456:7892', dst='fe80::e695:6eff:fe2f:2278')\
    /\
     data
pkt_mf_s202 = Ether(src="00:e0:4c:68:3c:95",dst="00:e0:4c:68:3c:93",type=0x27c0)/Calc(Pad =  bytes.fromhex("000000000000000000000065000000ca"))/data
pkt_mf_s203 = Ether(src="00:e0:4c:68:3c:95",dst="00:e0:4c:68:3c:93",type=0x27c0)/Calc(Pad =  bytes.fromhex("000000000000000000000065000000cb"))/data
pkt_mf_d1001 = Ether(src="03:e9:4c:68:3c:95",dst="03:e0:4c:68:3c:93",type=0x27c0)/Calc(Pad =  bytes.fromhex("000000000000000000000065000000ca"))/data
### for windows
if os.name == 'windows':
    import wmi
    def get_iface_desc():
...
for i in range(a):
    ...
    if a1==14:
        print("ipv4_geo_test")
        '''
        sendp(pkt_ipv4_03,inter=1,count=1,iface=iface)
        time.sleep(0.1)
        sendp(pkt_ipv4_04,inter=1,count=1,iface=iface)
        time.sleep(0.1)
        
        '''
        sendp(pkt_pwl_11,inter=1,count=1,iface=iface)
        time.sleep(0.1)
        sendp(pkt_pwl_12,inter=1,count=1,iface=iface)
        time.sleep(0.1)
        sendp(pkt_ipv6_7891,inter=1,count=1,iface=iface)
        time.sleep(0.1)
        sendp(pkt_ipv6_7892,inter=1,count=1,iface=iface)
        time.sleep(0.1)
    if a1==15:
        print("ipv4_0304_test")
        sendp(pkt_ipv4_03,inter=1,count=1,iface=iface)
        time.sleep(0.1)
        sendp(pkt_ipv4_04,inter=1,count=1,iface=iface)
        time.sleep(0.1)
    if a1==16:
        print("ipv6_9192_test")
        sendp(pkt_ipv6_7891,inter=1,count=1,iface=iface)
        time.sleep(0.1)
        sendp(pkt_ipv6_7892,inter=1,count=1,iface=iface)
        time.sleep(0.1)
    ...
    if a1==18:
        print("mf_0203_test")
        '''
        sendp(pkt_mf_s202,inter=1,count=1,iface=iface)
        time.sleep(0.1)
        sendp(pkt_mf_s203,inter=1,count=1,iface=iface)
        time.sleep(0.1)
        '''
        sendp(pkt_mf_d1001,inter=1,count=1,iface=iface)
        time.sleep(0.1)
