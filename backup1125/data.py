...
class Data():
    def __init__(self) -> None:
        ...
        self.pkt12 = Ether(src="00:e0:4c:68:3c:93",dst="00:e0:4c:68:3c:92")/\
                IP(src='192.168.40.182', dst='192.168.30.182')/\
                data
        self.pkt13 = Ether(src="00:e0:4c:68:3c:93",dst="00:e0:4c:68:3c:92")/\
                IP(src='192.168.40.182', dst='192.168.30.182')/\
                Calc(Pad= bytes.fromhex(data1))
        
        self.pkt_ipv4_03 = Ether(src="54:B2:03:91:14:26",dst="54:B2:03:91:33:02")/\
                IP(src='10.0.0.1', dst='10.0.0.3')/\
                data
        self.pkt_ipv4_04 = Ether(src="54:B2:03:91:14:26",dst="54:B2:03:91:33:03")/\
                IP(src='10.0.0.1', dst='10.0.0.4')/\
                data
        self.pkt_pwl_11 = Ether(src="12:34:56:78:90:10",dst="12:34:56:78:90:11",type=0x88ab)/\
                IP(src='10.0.0.10', dst='10.0.0.11')/\
                data
        self.pkt_pwl_12 = Ether(src="12:34:56:78:90:10",dst="12:34:56:78:90:12",type=0x88ab)/\
                IP(src='10.0.0.10', dst='10.0.0.12')/\
                data
        self.pkt_ipv6_7891 = Ether(src="54:B2:03:91:32:A0",dst="54:B2:03:91:30:9C")/\
                IPv6(src='1234::5678:9012:3456:7891', dst='fe80::e695:6eff:fe2f:2278')\
                /\
                data
        self.pkt_ipv6_7892 = Ether(src="54:B2:03:91:32:A0",dst="54:B2:03:91:30:9C")/\
                IPv6(src='1234::5678:9012:3456:7892', dst='fe80::e695:6eff:fe2f:2278')\
                /\
                data
        self.pkt_mf_s202 = Ether(src="00:e0:4c:68:3c:95",dst="00:e0:4c:68:3c:93",type=0x27c0)/Calc(Pad =  bytes.fromhex("000000000000000000000065000000ca"))/data
        self.pkt_mf_s203 = Ether(src="00:e0:4c:68:3c:95",dst="00:e0:4c:68:3c:93",type=0x27c0)/Calc(Pad =  bytes.fromhex("000000000000000000000065000000cb"))/data
        self.pkt_mf_d1001 = Ether(src="03:e9:4c:68:3c:95",dst="03:e0:4c:68:3c:93",type=0x27c0)/Calc(Pad =  bytes.fromhex("000000000000000000000065000000ca"))/data
